...
In the above screenshot, Sagas appear as horizontal bars in the Timings section. Now we can connect the dots between Sagas and call stacks in the Main section.
